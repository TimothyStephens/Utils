...
def main():
	...
	parser.add_argument('-g', '--goa', metavar='goa_uniprot_all.gaf', type=lambda x: __parse_file_check_compression(x, 'r'), required=False, default=sys.stdin, help='GOA data file (can be compressed or uncompressed) (default: stdin)')
