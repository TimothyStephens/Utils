...
R="test_data_big/SLtruncations.regions2check4misassemblies.bed"
B="test_data_big/aligned_reads.bam"
OUT="test_data_big/test.SLtruncations.regions2check4misassemblies.bed"
ORIG="test_data_big/orig.SLtruncations.regions2check4misassemblies.bed"
...
R="test_data_big/SLtruncations.regions2check4misassemblies.fullCDS.bed"
B="test_data_big/aligned_reads.bam"
OUT="test_data_big/test.SLtruncations.regions2check4misassemblies.fullCDS.bed"
ORIG="test_data_big/orig.SLtruncations.regions2check4misassemblies.fullCDS.bed"
