...
ConTable_sigOver <- ConTable_Enrichment[as.double(ConTable_Enrichment$PvalOver) <= 1, c(1,2,4)]
...
ConTable_sigUnder <- ConTable_Enrichment[as.double(ConTable_Enrichment$PvalUnder) <= 1, c(1,3,5)]
